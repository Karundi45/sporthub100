  ...
  const workouts = [
    {
      ...
      category: "workouts",
      exercises: [
        { name: "Barbell Bench Press", sets: 4, reps: "8-10", timeSet: "60s rest", videoDuration: "1:20" },
        { name: "Incline Dumbbell Press", sets: 3, reps: "10-12", timeSet: "45s rest", videoDuration: "0:45" },
        { name: "Pull-ups", sets: 4, reps: "Failure", timeSet: "60s rest", videoDuration: "1:00" }
      ]
    },
    {
      id: "w3",
      ...
      category: "workouts",
      exercises: [
        { name: "Squats", sets: 4, reps: "8-10", timeSet: "90s rest", videoDuration: "1:30" },
        { name: "Deadlifts", sets: 3, reps: "8-10", timeSet: "90s rest", videoDuration: "1:15" },
        { name: "Leg Press", sets: 3, reps: "10-12", timeSet: "60s rest", videoDuration: "0:50" }
      ]
    },
    {
      id: "r1",
      title: "Post-Run Leg Recovery",
      duration: "15 Min",
      level: "All Levels",
      category: "recovery",
      exercises: [
        { name: "Walking Lunges Stretch", sets: 2, reps: "10 per leg", timeSet: "30s hold", videoDuration: "2:00" },
        { name: "Standing Calf Stretch", sets: 2, reps: "30s hold", timeSet: "15s transition", videoDuration: "1:15" },
        { name: "Lying Quad Stretch", sets: 2, reps: "45s hold", timeSet: "15s transition", videoDuration: "2:30" }
      ]
    },
    {
      id: "r2",
      ...
      category: "recovery",
      exercises: [
        { name: "IT Band Roll", sets: 1, reps: "60s per leg", timeSet: "10s transition", videoDuration: "2:10" },
        { name: "Glute Roll", sets: 1, reps: "60s per side", timeSet: "10s transition", videoDuration: "2:00" },
        { name: "Upper Back Roll", sets: 1, reps: "60s", timeSet: "None", videoDuration: "1:30" }
      ]
    }
  ];
